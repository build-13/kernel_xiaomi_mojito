...
export KBUILD_BUILD_USER="build-13"
...
set_naming_for_bc() {
	KERNEL_NAME="STRIX-mojito-ksu-bc-lmk-personal-$ZIP_DATE"
	export ZIP_NAME="$KERNEL_NAME.zip"
}

set_naming_for_smt() {
	KERNEL_NAME1="STRIX-mojito-ksu-smt-lmk-personal-$ZIP_DATE"
...
gen_zip_for_bc() {
	...
	if ! [[ -d "/home/" || -d "/drone/src" || "/root/project" ]]; then
